<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.master" AutoEventWireup="true" CodeFile="MyProducts.aspx.cs" Inherits="Users_MyProducts" %>
            ...
            <asp:Repeater ID="rptrActiveProducts" runat="server">
                <ItemTemplate>
                    <div class="col-sm-3 col-md-3">
                        <a style="text-decoration:none;" href="MyProductsDetails.aspx?AUCID=<%# Eval("Aucid") %>">
                        <div class="thumbnail">
