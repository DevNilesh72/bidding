<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMaster.master" AutoEventWireup="true" CodeFile="MyProductsDetails.aspx.cs" Inherits="Users_MyProductsDetails" %>
                                ...
                                <asp:Repeater ID="rptrProductBid" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%# Eval("Bidprice") %></td>
                                            <td><%# Eval("Biddate") %></td>
                                            <% if(approveflag){ %> <td><a href="Aprrove.aspx?<%# getQuery(Eval("userid").ToString(),Eval("bidid").ToString()) %>">Aprove</a></td> <% } %>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                    </tbody>
